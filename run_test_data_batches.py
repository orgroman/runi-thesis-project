...
async def main():
    ...
    # Path to the JSON file that contains info about uploaded test files
    file_id_json = Path(
        r"C:\workspace_or_private\repos\runi-thesis-project\hidrive\patentmatch_test\openai_files_gpt4o_mapping_test.json"
    )
