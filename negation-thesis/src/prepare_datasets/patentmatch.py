...
class PatentMatchDataset:
    ...
    def annotate_negation(self,
        ...
        """
        logger.info(f"Annotating negation in the dataset with batch size {batch_size}"
...
if __name__ == "__main__":
    ...
    # Example usage
    dataset_file = r'C:\Users\orgrd\workspace\data\patentmatch_train\patentmatch_train.tsv'
